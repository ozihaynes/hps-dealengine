  ...
  it("accepts sandboxOptions on the analyze envelope", () => {
    const parsed = AnalyzeInputSchema.parse({
      ...
      sandboxOptions: {
        ...
        carry: { carryMonthsMaximumCap: 6, carryMonthsFormulaDefinition: "({DOM_zip}+30)/30" },
        holdCosts: { holdCostsFlipFastZip: 1.2, holdingCostsMonthlyDefaultTaxes: 250 },
        timeline: { daysToMoneyMaxDays: 60, clearToCloseBufferDays: 5 },
