-- supabase/bootstrap/intake_schema_seed_remote.sql
-- Run this in Supabase Dashboard > SQL Editor to seed the intake schema.
...
BEGIN
  ...
  -- Insert the default intake schema version if it doesn't exist
  ...
  RAISE NOTICE 'intake_schema_seed: Created/verified Standard Client Intake v1.0.0 for org %', v_org_id;
END;
$$ LANGUAGE plpgsql;

-- Verify it was created
SELECT id, org_id, semantic_version, display_name, is_active, created_at
