    ...
    <div className={inline ? "flex h-full min-h-0 flex-col p-3 md:p-4" : "flex h-full min-h-0 flex-col p-3"}>
      {error && (
        ...
        <div
          ...
          className={`group/message mt-3 flex-1 min-h-[220px] space-y-3 rounded-xl border border-[color:var(--glass-border)] bg-[color:var(--glass-bg)]/70 px-3 py-3 pr-2 transition ${
