        ...
        <div className="de-ai-window-header flex items-center justify-between border-b border-[color:var(--glass-border)] px-3 py-2 text-xs font-semibold text-[color:var(--text-secondary)] cursor-move">
          <div className="flex flex-col gap-1">
            <input
              ...
              value={
                w.activeSessionId
                  ? w.sessions.find((s) => s.id === w.activeSessionId)?.title ?? "Deal Strategist session"
                  : "Deal Strategist session"
              }
              onChange={(e) =>
                w.activeSessionId &&
                dispatch({
                  ...
                  title: e.target.value || "Deal Strategist session",
                })
              }
            />
            <button
              ...
              onClick={() => {
                ...
                dispatch({ type: "TOGGLE_PIN_SESSION", id: "dealStrategist", sessionId: w.activeSessionId });
              }}
            >
