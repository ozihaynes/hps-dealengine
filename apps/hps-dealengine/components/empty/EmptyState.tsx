...
const ActionButton = memo(function ActionButton({
  ...
  const variantStyles = {
    ...
    secondary: cn(
      'bg-[var(--card-bg-solid)] hover:bg-[var(--card-bg-hover)]',
      'text-slate-100',
      'border border-white/10',
      'focus:ring-slate-500'
    ),
    ghost: cn(
      'bg-transparent hover:bg-[var(--card-bg-solid)]',
    ...
    return (
      ...
      >
        ...
        {description && (
          <motion.p
            variants={itemVariants}
            className="text-sm text-slate-400 max-w-md mx-auto mb-6"
          >
            {description}
          </motion.p>
        )}
  ...
  return (
    ...
    >
      ...
      {description && (
        <motion.p
          variants={itemVariants}
          className="text-sm text-slate-400 max-w-md mb-6"
        >
          {description}
        </motion.p>
      )}
