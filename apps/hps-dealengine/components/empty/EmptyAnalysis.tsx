    ...
    >
      {showFeatures && (
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="bg-[var(--card-bg-hero)] rounded-xl p-4 max-w-md mx-auto text-left border border-white/10 backdrop-blur-xl"
        >
...
export const EmptyVerdictPanel = memo(function EmptyVerdictPanel({
  ...
  return (
    <div
      className={cn(
        'rounded-xl border border-white/10 bg-[var(--card-bg-hero)] backdrop-blur-xl',
        'p-8 text-center',
        className
      )}
