    ...
    <GlassCard>
      ...
      <div className="space-y-2">
        ...
        <div className="relative w-full h-12 rounded-full bg-gradient-to-r from-text-primary/5 via-text-primary/10 to-text-primary/5 shadow-inner overflow-hidden mb-32">
          ...
          >
            <div className="invisible group-hover:visible absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-gray-900 text-gray-100 text-xs rounded whitespace-nowrap z-50">
              Below Floor
