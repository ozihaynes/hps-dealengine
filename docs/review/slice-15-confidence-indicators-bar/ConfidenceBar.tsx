  ...
  return (
    <div className="flex flex-col items-center">
      <span className={cn(
        ...
        freshCount === total ? "text-emerald-400" : "text-zinc-100"
      )}>
        {freshCount}/{total}
      </span>
      {hasCriticalIssue && (
...
function MarketVelocitySummary({ data }: { data: MarketVelocity | null }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <span className={cn("text-lg font-bold uppercase", bandColors[band] ?? "text-zinc-400")}>
        {band}
      </span>
      <span className="text-xs text-zinc-400">
  ...
  return (
    <div className="flex flex-col items-center">
      <span className={cn(
        ...
        confidenceColors[confidence] ?? "text-zinc-400"
      )}>
        {confidence}
      </span>
      <span className="text-xs text-zinc-400">
