 ...
 * @version 2.3.0 (Slice 15 — Confidence Indicators Bar)
 */
...
export function V25EnhancementsZone({ className }: V25EnhancementsZoneProps) {
  ...
  return (
    ...
    >
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          ROW 2: Verdict Card (Decision Hero — Detailed View)
          ═══════════════════════════════════════════════════════════════════ */}
      <motion.div variants={itemVariants}>
        <VerdictCard
          verdict={verdict}
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          ROW 5: Evidence + Risk Gates Strip
          ═══════════════════════════════════════════════════════════════════ */}
      <motion.div
        variants={itemVariants}
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          ROW 8: Comps Evidence Pack (Comparable Sales)
          ═══════════════════════════════════════════════════════════════════ */}
      <motion.div variants={itemVariants}>
        <CompsEvidencePack
