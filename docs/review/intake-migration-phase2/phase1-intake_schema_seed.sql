  ...
  VALUES (
    ...
    '{
      ...
      "mappings": [
        ...
        {"source_field_key": "seller_strike_price", "target_deal_path": "payload.seller.lowest_acceptable_price", "transform": "parseCurrency", "overwrite_policy": "skip"},
        {"source_field_key": "reason_for_selling", "target_deal_path": "payload.seller.reason_for_selling", "transform": null, "overwrite_policy": "skip"},
        {"source_field_key": "timeline", "target_deal_path": "payload.seller.seller_timeline", "transform": null, "overwrite_policy": "skip"},
        {"source_field_key": "additional_notes", "target_deal_path": "payload.seller.seller_notes", "transform": null, "overwrite_policy": "skip"},
        ...
        {"source_field_key": "sqft", "target_deal_path": "payload.cma.subject.sqft", "transform": "parseInt", "overwrite_policy": "skip"},
        {"source_field_key": "year_built", "target_deal_path": "payload.property.year_built", "transform": "parseInt", "overwrite_policy": "skip"},
        {"source_field_key": "asking_price", "target_deal_path": "payload.market.asking_price", "transform": "parseCurrency", "overwrite_policy": "skip"},
        {"source_field_key": "mortgage_balance", "target_deal_path": "payload.debt.senior_principal", "transform": "parseCurrency", "overwrite_policy": "skip"},
        {"source_field_key": "monthly_payment", "target_deal_path": "payload.debt.monthly_payment", "transform": "parseCurrency", "overwrite_policy": "skip"},
        {"source_field_key": "behind_on_payments", "target_deal_path": "payload.foreclosure.behind_on_payments", "transform": null, "overwrite_policy": "skip"},
        {"source_field_key": "in_foreclosure", "target_deal_path": "payload.foreclosure.is_in_foreclosure", "transform": "parseBoolean", "overwrite_policy": "skip"},
        {"source_field_key": "foreclosure_sale_date", "target_deal_path": "payload.foreclosure.auction_date", "transform": "parseDate", "overwrite_policy": "skip"},
        {"source_field_key": "overall_condition", "target_deal_path": "payload.systems.overall_condition", "transform": null, "overwrite_policy": "skip"},
        {"source_field_key": "roof_age", "target_deal_path": "payload.systems.roof_year_installed", "transform": "ageToYear", "overwrite_policy": "skip"},
        {"source_field_key": "hvac_age", "target_deal_path": "payload.systems.hvac_year_installed", "transform": "ageToYear", "overwrite_policy": "skip"},
        {"source_field_key": "repair_notes", "target_deal_path": "payload.systems.repair_notes", "transform": null, "overwrite_policy": "skip"},
        {"source_field_key": "absorption_rate", "target_deal_path": "payload.market.absorption_rate", "transform": "parseFloat", "overwrite_policy": "skip"},
        {"source_field_key": "cash_buyer_share_pct", "target_deal_path": "payload.market.cash_buyer_share_pct", "transform": "parseFloat", "overwrite_policy": "skip"}
      ],
      "evidence_mappings": [
