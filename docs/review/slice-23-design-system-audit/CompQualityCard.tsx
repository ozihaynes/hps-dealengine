...
function MetricBox({ value, label, testId }: MetricBoxProps): JSX.Element {
  return (
    <div
      className="flex flex-col items-center p-2 rounded-lg bg-zinc-800/50"
      data-testid={testId}
    >
...
export const CompQualityCard = memo(function CompQualityCard({
  ...
  if (!compQuality) {
    return (
      ...
      >
        <h3 className="text-sm font-medium text-zinc-300 mb-2">Comp Quality</h3>
    ...
    return (
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-medium text-zinc-300">Comp Quality</h3>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          {showMethod && scoring_method && (
            <span
              className="text-[10px] text-zinc-500 bg-zinc-700/50 px-1.5 py-0.5 rounded"
