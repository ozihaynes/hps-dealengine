...
export const CardSkeleton = memo(function CardSkeleton({
  ...
  if (variant === 'minimal') {
    return (
      <div
        className={cn(
          'rounded-lg border border-zinc-700/50 bg-zinc-900/60',
          'p-4',
          className
        )}
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="grid grid-cols-3 gap-2 px-4 py-3 border-t border-zinc-700/30"
      >
        {/* Net Metric */}
      ...
      {showActions && (
        <motion.div
          variants={itemVariants}
          className="flex items-center gap-2 p-4 pt-2 border-t border-zinc-700/30"
        >
...
export const MetricCardSkeleton = memo(function MetricCardSkeleton({
  ...
  return (
    <motion.div
      ...
      animate="visible"
      className={cn(
        'rounded-lg border border-zinc-700/50 bg-zinc-800/50',
        'p-4',
        className
      )}
