        ...
        {showTooltip && (
          <motion.div
            ...
            className={cn(
              ...
              // Text
              sizeConfig.tooltip,
              "text-zinc-100 whitespace-nowrap",
              // Arrow
              "after:absolute after:top-full after:left-1/2 after:-translate-x-1/2",
              "after:border-4 after:border-transparent after:border-t-zinc-800"
            )}
            role="tooltip"
          >
            ...
            {reason && (
              <div className="text-xs text-zinc-400 mt-1 max-w-[200px] whitespace-normal">
                {reason}
              </div>
            )}
          </motion.div>
