...
function EvidenceChecklistContent({ health }: { health: EvidenceHealth }): JSX.Element {
  ...
  const STATUS_STYLES = {
    ...
    pending: { icon: "○", color: "text-zinc-400", bg: "bg-zinc-500/20" },
  } as const;
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        evidenceHealth && "hover:border-zinc-600 hover:bg-zinc-800/80 cursor-pointer",
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-zinc-300">Evidence</span>
          {isDemoMode && (
