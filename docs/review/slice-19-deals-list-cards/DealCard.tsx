...
function MetricItem({
  ...
  return (
    <div className="flex flex-col">
      <span className={cn("text-sm font-semibold", accent ?? "text-zinc-100")}>
        {value}
      </span>
  ...
  return (
    <motion.article
      ...
      className={cn(
        ...
        theme.bg,
        // Focus/hover states
        "focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-zinc-950",
        theme.ring,
    ...
    >
      ...
      {/* Metrics Row */}
      <div className="grid grid-cols-3 gap-2 px-4 py-3 border-t border-zinc-700/30">
      ...
      {/* Actions Row */}
      <div className="flex items-center gap-2 p-4 pt-2 border-t border-zinc-700/30">
        <Link
