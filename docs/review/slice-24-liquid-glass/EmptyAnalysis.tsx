    ...
    >
      {showFeatures && (
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="bg-slate-900/50 rounded-xl p-4 max-w-md mx-auto text-left border border-white/10 backdrop-blur-xl"
        >
...
export const EmptyVerdictPanel = memo(function EmptyVerdictPanel({
  ...
  return (
    <div
      className={cn(
        'rounded-xl border border-white/10 bg-slate-800/30 backdrop-blur-xl',
        'p-8 text-center',
        className
      )}
