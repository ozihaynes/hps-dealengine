...
function MapPlaceholder({
  ...
  return (
    <div
      className="relative h-40 rounded-xl bg-slate-800/50 border border-white/10 overflow-hidden backdrop-blur-xl"
...
export const CompsEvidencePack = memo(function CompsEvidencePack({
  ...
  return (
    ...
    >
      ...
      {hiddenCount > 0 && (
        <p
          className="text-center text-xs text-slate-500 mt-3 py-2 bg-slate-800/50 rounded"
