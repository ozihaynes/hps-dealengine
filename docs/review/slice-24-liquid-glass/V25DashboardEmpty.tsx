...
export const V25DashboardEmpty = memo(function V25DashboardEmpty({
  ...
  if (variant === 'minimal') {
    return (
      <div
        ...
        className={cn(
          'rounded-xl border border-white/10 bg-slate-800/30 backdrop-blur-xl p-4 text-center',
          className
        )}
      >
  ...
  if (variant === 'compact') {
    return (
      <motion.div
        ...
        className={cn(
          'rounded-xl border border-white/10 bg-slate-800/50 backdrop-blur-xl p-6 text-center',
          className
        )}
      >
  ...
  return (
    <motion.div
      ...
      className={cn(
        'rounded-xl border border-white/10 bg-slate-800/50 backdrop-blur-xl p-8',
        className
      )}
    >
