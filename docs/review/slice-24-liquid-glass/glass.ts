...
export const GLASS_FOUNDATION = {
  ...
  // Glass card backgrounds (with transparency)
  card: 'bg-slate-800/60',        // 60% - standard glass
  cardHover: 'bg-slate-800/70',   // 70% - hover state
  cardActive: 'bg-slate-800/80',  // 80% - active/pressed

  // Hero/overlay backgrounds
  hero: 'bg-slate-800/50',        // 50% - hero sections (more see-through)
  overlay: 'bg-slate-900/90',     // 90% - modals, drawers (more opaque)
...
export const GLASS_PRESETS = {
  // HERO: Maximum prominence, decision zone
  hero: [
    'rounded-2xl',
    'bg-slate-800/50',
  ...
  // PANEL: Larger container sections
  panel: [
    'rounded-2xl',
    'bg-slate-900/70',
    'backdrop-blur-xl saturate-150',
  ...
  // METRIC: Small inline metric boxes
  metric: [
    'rounded-lg',
    'bg-slate-800/40',
    'backdrop-blur-lg',
  ...
  // VERDICT: Cards with colored accent border
  verdict: [
    'rounded-xl',
    'bg-slate-800/60',
    'backdrop-blur-xl',
  ...
  // STRIP: Horizontal strips (risk gates, evidence health)
  strip: [
    'rounded-xl',
    'bg-slate-800/50',
    'backdrop-blur-lg',
...
export const GLASS_INTERACTIVE = {
  ...
  active: 'active:bg-slate-800/80 active:scale-[0.99]',
