...
// UNIFIED GLASS STYLE - No colored backgrounds per exit type
// All exit cards use the same glass appearance
...
function ExitCard({
  ...
  if (!breakdown) {
    return (
      <div
        ...
        className={cn(
          "rounded-lg border border-slate-700/50 bg-slate-800/30 backdrop-blur-sm",
          compact ? "p-3" : "p-4",
          "flex flex-col"
        )}
      >
  ...
  return (
    <div
      ...
      className={cn(
        // UNIFIED GLASS STYLE - same for all cards
...
export const NetClearancePanel = memo(function NetClearancePanel({
  ...
  if (!netClearance) {
    return (
      <div
        ...
        data-state="empty"
        className={cn(
          "rounded-xl border border-white/10 bg-slate-800/50 backdrop-blur-xl p-4",
          className
        )}
      >
  ...
  return (
    <div
      ...
      className={cn(
        "rounded-xl border border-white/10 bg-slate-800/50 backdrop-blur-xl",
        compact ? "p-3" : "p-4",
        className
      )}
    >
