            ...
            <GlassCard className="w-full p-8 md:p-10 relative overflow-hidden border-t border-accent-green/30">
                ...
                <div className="text-center mb-10">
                    ...
                    <div className={`mt-8 max-w-md mx-auto transition-all duration-700 delay-300 transform ${step >= 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                        ...
                        <Link
                            href="/import/wizard"
                            className="mt-4 w-full py-3 flex items-center justify-center gap-3
                                     bg-slate-800/60 hover:bg-slate-800/90
                                     border border-slate-600 hover:border-blue-500/50
                                     text-slate-200 hover:text-white font-semibold text-base
                                     rounded-xl transition-all duration-300
                                     hover:shadow-lg hover:shadow-blue-500/10"
                        >
                            <FileSpreadsheetIcon className="w-5 h-5 text-blue-400" />
                            Bulk Import
