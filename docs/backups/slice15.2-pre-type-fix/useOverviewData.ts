 ...
 * - No `as any` casts — proper type narrowing
 *
...
/**
 * Snapshot data structure for Command Center components.
 * This is the canonical type that PulseBar and DecisionCanvas expect.
 */
 ...
 */
const DEFAULT_SNAPSHOT: CommandCenterSnapshot = {
...
function generateVerdictReasons(
  snapshot: Omit<CommandCenterSnapshot, "verdict" | "verdict_reasons">,
  verdict: VerdictType
): string[] {
...
export type { CommandCenterSnapshot as SnapshotData };
